namespace Core {
    ...
    public enum EventType { FireStarted, FireSpread, FireExtinguished, TileUpdated, BudgetChanged, GameEnded, LevelUp, RoundComplete, UnitDeployed, EnvironmentImpact, FireNoLongerEdge, TileRecovered, IncomeGenerated, MoneySpent, ResourceTransferred, CityInDanger, CityCritical, CityDestroyed }
